---
title: Staff Scanner Redesign — Contract (round 2)
service: shared
type: contract
status: active
...
Goal: make the React staff app match the design deck `docs/_archive/design-deck/Jaqyn.dc.html` (the
...
- Markup: `docs/_archive/design-deck/Jaqyn.dc.html` lines **1009–1253** (the `isStaff` block: scan
