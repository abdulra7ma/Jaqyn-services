...
urlpatterns = [
    ...
    path(
        ...
        name="business-campaign-detail",
    ),
    path(
        "<uuid:campaign_id>/publish/",
        CampaignPublishView.as_view(),
        name="business-campaign-publish",
    ),
    path(
        "<uuid:campaign_id>/pause/",
        CampaignPauseView.as_view(),
        name="business-campaign-pause",
    ),
    path(
        "<uuid:campaign_id>/resume/",
        CampaignResumeView.as_view(),
        name="business-campaign-resume",
    ),
    path(
        "<uuid:campaign_id>/end/",
        CampaignEndView.as_view(),
        name="business-campaign-end",
    ),
    path(
        "<uuid:campaign_id>/cancel/",
        CampaignCancelView.as_view(),
        name="business-campaign-cancel",
    ),
    path(
        "<uuid:campaign_id>/duplicate/",
        CampaignDuplicateView.as_view(),
        name="business-campaign-duplicate",
    ),
    path(
    ...
    path(
        "<uuid:campaign_id>/image/",
        CampaignImageUploadView.as_view(),
        name="business-campaign-image",
    ),
    path(
        "<uuid:campaign_id>/social-post/",
        CampaignSocialPostView.as_view(),
        name="business-campaign-social-post",
    ),
    path(
        "<uuid:campaign_id>/vouchers/",
        CampaignVouchersView.as_view(),
        name="business-campaign-vouchers",
    ),
    path(
        "<uuid:campaign_id>/analytics/",
        CampaignAnalyticsView.as_view(),
        name="business-campaign-analytics",
    ),
]
